...
#or in sorted form
barplot(sort(returns.cor[1:20,c('VV')]),las=2,ylim=c(0,1.0))
title('Sorted Correlations with VV')
...
plot(-10,10,type='p',xlim=c(0.1,0.3),ylim=c(-0.6,0.3),xlab='PC 1',ylab='PC 2')
text(pc.1,pc.2,labels=names(pc.1),cex=0.75)
